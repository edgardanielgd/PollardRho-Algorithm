"""
https://github.com/ashutosh1206/Crypton/blob/master/Discrete-Logarithm-Problem/Algo-Pollard-Rho/pollardrho.py
Source: Handbook of Applied Cryptography chapter-3
        http://cacr.uwaterloo.ca/hac/about/chap3.pdf
""" 

# Here are the libraries then...
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        y = pow(2, num, 383)
        print(pow(2, pollardrho(2, y, 383, 191), 383))
        print(y)
        assert pow(2, pollardrho(2, y, 383, 191), 383) == y
    """
    y=8
    print(pollardrho(2, y, 23, 11))
    print(y)
    assert pow(2, pollardrho(2, y, 23, 11), 23) == y
